    ...
    function orderButton(){
        ...
        $('input').each(function() {
            if(this.checked){
                ...
                sessionStorage.setItem(`productprice+${i}`, this.price);
        ...
        <div>
            ...
            <div>
                {products.map(product=>(
                        ...
                        <img src="https://craftnamiusah.ru/wp-content/uploads/2023/02/high-view-modeling-of-clay-on-a-potter-s-wheel-scaled.jpg"></img>
